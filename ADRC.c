...
/*  r     h      N                  beta_01   beta_02    beta_03     b0     beta_0  beta_1     beta_2     N1     C    alpha1  alpha2  zeta    b*/
 {300000 ,0.005 , 3,               300,      4000,      10000,      100,    0.002,   1.2,      0.0010,    5,    5,    0.8,   1.5,    0.03,    0.05},
 {300000 ,0.005 , 3,               300,      4000,      10000,      100,    0.002,   1.2,      0.0010,    5,    5,    0.8,   1.5,    0.03,    0.05},
 {300000 ,0.005 , 3,               300,      4000,      10000,      50,     0.002,   1.2,      0.0005,    5,    5,    0.8,   1.5,    0.03,    0.05},
};
...
void ADRC_Control(Fhan_Data *fhan_Input,float expect_ADRC,float feedback_ADRC)
{
     ...
     */
      ...
      //fhan_Input->u=Constrain_Float(fhan_Input->u,-450,450);不加入扰动补偿
      fhan_Input->u=Constrain_Float(fhan_Input->u0,-450,450);//加入扰动补偿
}
